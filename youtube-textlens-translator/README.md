...
- Liara includes Gemini 2.5 Flash Lite, Gemini 3.1 Flash Lite, and Gemini 2.5 Flash options.
...
1. Download `YouTube-TextLens-Translator-0.1.1-macOS.dmg` from the GitHub release.
2. Open the DMG.
